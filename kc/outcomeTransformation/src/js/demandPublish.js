...
(function (window, $) {
    ...
    window.demandPublishService = demandPublishService();

    function demandPublishService() {
        var demandPublishService = {};
        ...
        demandPublishService.showpage = function (pagenum,currentpage) {
