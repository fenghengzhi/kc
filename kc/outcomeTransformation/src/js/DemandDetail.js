...
(function (window, $) {
    ...
    window.DemandDetailService = DemandDetailService();

    function DemandDetailService() {
        var DemandDetailService = {};
        ...
        function getInfo() {
            ...
            hieknjs.kgLoader({
                type: 0,
                url: configService.RESTFUL_SERVICE_BASE_URL + 'transformation/get/require',
                that: $('#content')[0],
                postData: {},
                urlData: {
                    id: id,
                ...
                , {type: parseInt(d.type)}).name}</div>
                    ...
                    <li style="margin-top:8px;">
                        <div class="lf">
                            ...
                            <div class="dtail" style="color:#5f8bc9">${d.budget}</div>
                        </div>
                        <div class="mid">
                    ...
                    <div class="left clearfix">
                        ...
                        <div class="none">
                            ...
                            <div class="contact-detail">
                                <div><p>需求联系人信息：</p><span>${d.contactsName || ''}</span></div>
                                <div class="domain">
                                    <p>涉及技术领域：</p><span>${JSON.parse(d.domain || '[]').join(' ')}</span>
                                </div>
                                <div class="part">
                                    <p>需求所需阶段：</p><span>${d.phase || ''}</span>
                                </div>
                                <div class="kind">
                                    <p>需求类型：</p><span>${JSON.parse(d.requireType || '[]').join(' ')}</span>
                                </div>
                            </div>

                            <div class="contact-detail" style="margin-top:30px;">
                                <p>需求详细内容：</p>
                                <div class="domain"><p>需求结局的主要技术难题：</p><span></span>
                                </div>
                                <div class="part">
                                ...
                                <div class="kind clearfix">
                                    <ul>
                                        <li style="width: 50%;"><p>需求投入经费：</p><span style="line-height: 24px;">${d.budget || ''}</span>
                                        </li>
                                        <li style="width: 50%;"><p>需求研发周期：</p><span style="line-height: 24px;">${d.developmentCycle || ''}</span>
                                        </li>
                                    </ul>
                                ...
                                <div class="cooperation">
                                    <p>期望合作方式：</p><span>${JSON.parse(d.cooperationWay || '[]').join(' ')}</span>
                                </div>
                                <div class="delivery">
