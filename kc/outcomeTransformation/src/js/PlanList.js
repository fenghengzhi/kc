...
(function (window, $) {
    ...
    function PlanListService() {
        ...
        function getInfo() {
            ...
            hieknjs.kgLoader({
                type: 1,
                url: configService.RESTFUL_SERVICE_BASE_URL + 'transformation/list/scheme',
                that: $('.left .lists')[0],
                postData: {
                    queryCondition
                },
                ...
                for (let d of data.rsData) {
                    html +=
                        `<div class="con">
                            ...
                            <div class="clm">
                                <a href="PlanDetail.html?id=${d.id}" class="list-title">
                                ...
                                <div class="btn">
                                    <a href="PlanDetail.html?id=${d.id}" class="hu-btn btn-primary btn-sm" style="min-width: 60px;padding:0 12px;">查看详情
                                    </a>
                               </div>
                            </div>
                        </div>`;
