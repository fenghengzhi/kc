...
(function (window, $) {
    ...
    function outcomeBiddingDetailService() {
        ...
        outcomeBiddingDetailService.id=commonService.getSearchParm('id');
        ...
        function getData() {
            hieknjs.kgLoader({
                type: 0,
                url: configService.RESTFUL_SERVICE_BASE_URL + 'transaction/get/achievement',
                that: $('.main')[0],
                postData: {},
                urlData: {
                    id: outcomeBiddingDetailService.id,
                },
