...
(function (window, $) {
    ...
    window.tradeShowDetailService = tradeShowDetailService();

    function tradeShowDetailService() {
        var tradeShowDetailService = {};

        tradeShowDetailService.url=commonService.getSearchParm('url');
        tradeShowDetailService.id=commonService.getSearchParm('id');
        ...
        function getData() {
            hieknjs.kgLoader({
                type: 0,
                url: configService.RESTFUL_SERVICE_BASE_URL + 'transaction/get/'+tradeShowDetailService.url,
                that: $('.main')[0],
                postData: {},
                urlData: {
                    id: tradeShowDetailService.id,
                },
                        ...
                        var html=`<div class="info-serviceProvider">
                                    ...
                                    <div class="info-con">
                                        ...
                                        <div class="info-con-btn">
                                            <button class="hu-btn btn-primary btn-md" disabled>我要投标</button>
                                        </div>
                                    </div>
